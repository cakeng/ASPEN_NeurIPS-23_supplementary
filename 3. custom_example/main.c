...
int main(void)
{
    ...
    aspen_dnn_t *aspen_dnn = apu_create_dnn("resnet50_aspen.cfg", "resnet50_data.bin");
    apu_save_dnn_to_file (aspen_dnn, "resnet50_base.aspen");
    nasm_t *aspen_nasm = apu_generate_nasm (aspen_dnn, batch_size, 10);
    ...
    rpool_add_nasm (rpool, aspen_nasm, 1.0, "input_batch.bin");
